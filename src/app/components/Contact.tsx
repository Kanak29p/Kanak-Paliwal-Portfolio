...
const INFO_CARDS = [
  {
    icon: <Mail size={20} />,
    label: "Email",
    value: "k29paliwal@gmail.com",
    href: "mailto:k29paliwal@gmail.com",
  },
  {
    icon: <MapPin size={20} />,
    label: "Location",
  ...
  },
  {
    icon: <Github size={20} />,
    label: "GitHub",
    value: "github.com/Kanak29p",
    href: "https://github.com/Kanak29p",
  },
  {
    icon: <Linkedin size={20} />,
    label: "LinkedIn",
    value: "kanak-paliwal",
    href: "https://linkedin.com/in/kanak-paliwal",
  },
];
